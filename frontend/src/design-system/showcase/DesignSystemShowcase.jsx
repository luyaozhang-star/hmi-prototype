        ...
        <section className="ds-showcase__section">
          ...
          <div className="ds-showcase__card-container">
            ...
            <Card>
              ...
              <Typography variant="body-tiny" className="ds-showcase__variant-specs" style={{ marginBottom: 'var(--spacing-16)' }}>
                Contained tabs with a background container - ideal for media apps and navigation
              </Typography>
              <Tabs
                tabs={[
                  { id: 'home', label: 'Home' },
            ...
            <Card>
              ...
              <Typography variant="body-tiny" className="ds-showcase__variant-specs" style={{ marginBottom: 'var(--spacing-16)' }}>
                Minimal tabs with bottom border indicator - suitable for settings and detail views
              </Typography>
              <Tabs
                tabs={[
            ...
            <Card>
              ...
              <div className="ds-showcase__tabs-grid">
                <div>
                  <Typography variant="body-tiny" className="ds-showcase__variant-specs" style={{ marginBottom: 'var(--spacing-8)' }}>
                    Regular (64px height)
                  </Typography>
                  <Tabs
                    tabs={[
